...
const Navbar = () => {
    ...
    return (
        <div className="navbar lg:justify-around justify-start  bg-transparent absolute">
            <div className="flex items-center">
                ...
                <a className="flex items-center font-bold text-2xl md:text-3xl"><svg width="63" height="42" viewBox="0 0 63 42" fill="none" xmlns="http://www.w3.org/2000/svg">
